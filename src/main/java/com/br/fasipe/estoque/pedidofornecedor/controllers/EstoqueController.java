...
import com.br.fasipe.estoque.pedidofornecedor.services.EstoqueService;
...
public class EstoqueController {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Estoque> atualizarEstoque(@PathVariable Integer id, @Valid @RequestBody Estoque estoque) {
        log.info("Atualizando estoque ID: {}", id);

        estoque.setId(id); // Garante que o ID da URL seja usado para a atualização
