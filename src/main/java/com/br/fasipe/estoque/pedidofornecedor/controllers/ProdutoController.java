...
import com.br.fasipe.estoque.pedidofornecedor.services.ProdutoService;
...
public class ProdutoController {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Produto> atualizarProduto(@PathVariable Integer id, @Valid @RequestBody Produto produto) {
        log.info("Atualizando produto ID: {}", id);
        
        produto.setId(id); // Garante que o ID da URL seja usado
