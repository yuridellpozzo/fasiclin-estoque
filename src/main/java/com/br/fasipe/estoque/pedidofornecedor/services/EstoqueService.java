...
import com.br.fasipe.estoque.pedidofornecedor.repository.EstoqueRepository;
...
public class EstoqueService extends BaseService {
    ...
    public Page<Estoque> findByProduto(Integer idProduto, int page, int size) {
        ...
        Page<Estoque> estoques = estoqueRepository.findByProdutoId(idProduto, pageable);
    ...
    public Page<Estoque> findByAlmoxarifado(Integer idAlmoxarifado, int page, int size) {
        ...
        Pageable pageable = createDefaultPageable(page, size);
        Page<Estoque> estoques = estoqueRepository.findByProdutoAlmoxarifadoId(idAlmoxarifado, pageable);
    ...
    public Page<Estoque> findEstoquesComQuantidadeBaixa(Integer quantidadeMinima, int page, int size) {
        ...
        Pageable pageable = createDefaultPageable(page, size);
        Page<Estoque> estoques = estoqueRepository.findByQuantidadeEstoqueLessThan(quantidadeMinima, pageable);
    ...
    public Page<Estoque> findByLote(Integer idLote, int page, int size) {
        ...
        Pageable pageable = createDefaultPageable(page, size);
        Page<Estoque> estoques = estoqueRepository.findByLoteId(idLote, pageable);
    ...
    public long countComQuantidadeBaixa(Integer quantidadeMinima) {
        return estoqueRepository.countByQuantidadeEstoqueLessThan(quantidadeMinima);
    }
}